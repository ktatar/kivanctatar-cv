...
\section{Academic Publications}
    ...
    \cvitem{J13}{Zappi, V.,\textcolor{magenta}{Tatar, K}. \textit{Neural Audio Instruments: Epistemological and Phenomenological Perspectives on Musical Embodiment of Deep Learning}. Accepted with minor revisions to Frontiers in Computer Science.}

    \cvitem{J12}{Liu X., Cotton K., \textcolor{magenta}{Tatar, K.}\textit{Revisiting a Decade of Computational Game Creativity}. Submitted to Transactions on Computer-Human Interaction (ToCHI), Association for Computing Machinery (ACM).}

    \cvitem{J11}{Liu X., Holopainen J., \textcolor{magenta}{Tatar, K.} \textit{Understanding Co-Storytelling with Large Language Models (LLMs): An Exploratory Content Analysis of ``AI Dungeon'' Subreddit}. Submitted to the International Journal of Human-Computer Interaction, Taylor and Francis }

    \cvitem{J10}{Madaghiele V., Lund L., Holzer D., Kelkar T., \textcolor{magenta}{Tatar, K.}, and Holzapfel A. \textit{Expanding the machine: notating generative synthesis with a state-based representation and an interactive timbre space}. Submitted to Organised Sound, Cambridge Press.}

    \cvitem{J9}{*Fröhlich M. M., Cotton K., \textcolor{magenta}{Tatar, K.} \textit{Mass Consumption of AI Spectacle: An Analysis of Refik Anadol’s Nature Dreams}. Submitted to Leonardo, MIT Press.}

    \cvitem{J8}{Cotton, K., Kaila, A.K.,Jääskeläinen, P., Holzapel, A., \textcolor{magenta}{Tatar, K}. Imploding between the Facts and Concerns of Musical-AI: A Multidisciplinary Method for Analysing Human-AI Musical Interaction. Accepted and in press at Humanities and Social Sciences Communications, Springer Nature.}
    ...
    \cvitem{C20}{Cotton, K., de Vries K., Holzapfel A., Berglund K., \textcolor{magenta}{Tatar, K.}. \textit{Revising MIR Research Practices for Singing Data Collection}. Submitted to the  26th conference of the International Society for Music Information Retrieval (ISMIR 2025).}
...
\cvitem{2024-08-29}{\href{https://kivanctatar.com/Exposing-the-Bias-in-AI}{\textbf{Exposing the Bias in Artificial Intelligence}}. Live audiovisual performance at Koami Art Festival 2024, approx. 300 audience, in Gothenburg, Sweden.}

\cvitem{2023-09}{\href{https://kivanctatar.com/expert-proc}{\textbf{Expert Procrastinator's Tool: Artificial Intelligence}}. A video artwork at the collective exhibiton \textit{Eskizden Piksele No.2}, with Nergiz   Yesil, Cem Sonel, Can Büyükberber, Afra Sönmez, Selçuk Artut, Alp Tugan, Güvenç Özel, Candas Sisman; at the historical city of Troy, as a part of the festival Troy Kültür Yolu \textcolor{magenta}{Troy, Canakkale, Turkey. Funded by Culture Ministry of Turkey,
...
\cvitem{}{\small VR: Vetenskapsrådet: Swedish Research Council}
\cvitem{}{\small WASP-HS: The Wallenberg AI, Autonomous Systems and Software Program – Humanity and Society}
...
\cvitem{VR-1}{\textit{VOICE. AI-generated voices. Legal and societal perspectives.} funded by VR Research Environment on Social Sciences and Humanities call, Katja de Vries (PI), Andre Holzapfel (co-PI), Kıvanç Tatar (co-PI), Kalle Berglund (co-PI). 18 million SEK.}
...
\cvitem{2025}{\textbf{Qi Chen and Gritta Joshy.} \textit{Curriculum Learning for Symbolic Music Generation with Transformers}. \textcolor{magenta}{Main Supervisor: K{\i}van\c{c} Tatar}, co-Supervisor: Stefano Sarao Mannelli, examiner: Dag Wedelin. Master Thesis.}

\cvitem{2025}{\textbf{Ipek Korkmaz.} \textit{Investigating Impact of Audio Features Loss Functions for Audio Synthesis using Variational Autoencoders}. \textcolor{magenta}{Main Supervisor: K{\i}van\c{c} Tatar}, examiner: Simon Olsson. Master Thesis.}

\cvitem{2024}{\textbf{Priscilla Tissot.} \textit{A Framework for Investigating Bias in Generative Deep Learning models for Image and Video Applications}. \textcolor{magenta}{Main Supervisor: K{\i}van\c{c} Tatar}. Summer Intern.}

\cvitem{2024}{\textbf{Antonio Mangoni Di S Stefano.} \textit{Neuro-Symbolic Creation of Non-Playable Characters}, Examiner: Morten Fjeld.}

\cvitem{2024}{\textbf{Filip Lundström.} \textit{Incorporating Brain-Computer Interface (Muse) with Deep Learning Audio Synthesis}, Examiner: Palle Dahlsted.}

\cvitem{2024}{\textbf{Matteo Caravati.} \textit{Interfacing ErgoJr with Creative Coding Platforms}. \textcolor{magenta}{Main Supervisor: K{\i}van\c{c} Tatar}. Summer Intern.}

\cvitem{2023}{\textbf{Nicolas Gry.}\textit{Embedding Deep Learning Synthesis in Ossia framework}. \textcolor{magenta}{Main Supervisor: K{\i}van\c{c} Tatar}. Summer Intern.}

\cvitem{2023}{\textbf{Don Sameera Parakrama Ratnayake.} \textit{Immersive Tactile Steering Interface: A bio-feedback interface for steering devices}. \textcolor{magenta}{Main Supervisor: K{\i}van\c{c} Tatar}, Examiner: Palle Dahlsted.}

\cvitem{2023}{\textbf{Anton Eriksson.} \textit{Applying Affect Estimation to
3D Music Visualization}. \textcolor{magenta}{Main Supervisor: K{\i}van\c{c} Tatar}, Examiner: Palle Dahlsted.}

\cvitem{2023}{\textbf{David H\"ogberg.} \textit{Latent Vector Synthesis}. \textcolor{magenta}{Main Supervisor: K{\i}van\c{c} Tatar}, Examiner: Staffan Bj\"ork.}
...
\cvitem{}{\textbf{Lin Luo and Zixi Geng.} \textit{The EaseFit:
...
\section{Teaching Experiences}
    ...
    \cvitem{2025 Spring}{\textbf{Examiner}, \href{https://www.chalmers.se/en/education/your-studies/course-selection-and-registration/select-courses/choose-a-tracks-course/machine-learning-and-ai-through-artistic-innovation/}{Machine Learning and AI through Artistic Innovation}, as a part of \href{https://www.chalmers.se/en/education/your-studies/course-selection-and-registration/select-courses/choose-a-tracks-course/}{Chalmers TRACKS initiative}, Chalmers University of Technology, Gothenburg, Sweden.}

    \cvitem{2024-03}{\textbf{Invited Lecture:} \textit{Organized Sound Spaces with Machine Learning}, as a part of \href{https://mutor-2.github.io/ScienceOfMusic/about.html}{\_MUTOR Online Lecture Series - Artificial Intelligence for Music and Multimedia at Hamburg Open Online University program and Hamburg University of Music and Drama}, funded by The Foundation for Innovation in Higher Education and to the Multimedia Office Hamburg, Germany}

    \cvitem{2024 Spring}{\textbf{Examiner.} \href{https://chalmers.instructure.com/courses/29250}{TRA 385 - Emerging technologies through artistic innovation}, as a part of \href{https://www.chalmers.se/en/education/your-studies/course-selection-and-registration/select-courses/choose-a-tracks-course/}{Chalmers TRACKS initiative}, 18 students, Chalmers University of Technology, Gothenburg, Sweden.}
    ...
    \section{Pedagogy Training}
    \cvitem{2024}{CLS930 Diversity and inclusion for learning in Higher Education. University of Gothenburg}
    \cvitem{2024}{PIL201: Supervision in Postgraduate Programmes. University of Gothenburg}
    \cvitem{2024}{PIL 103: Teaching and Learning in Higher Education 2\3. University of Gothenburg}
    \cvitem{2023}{PIL 102: Teaching and Learning in Higher Education 2. University of Gothenburg}
    \cvitem{2023}{PIL 101: Teaching and Learning in Higher Education 1. University of Gothenburg}
...
\cvitem{2021}{\textbf{Electronics}, Plastic Biosphere No.3, Auto Impulse, Independent}
...
\section{Academic Citizenship and Community Engagement}
\cvitem{2025}{\textbf{Reviewer}. Frontiers in Computer Science. 1 paper}
\cvitem{2025}{\textbf{Meta-Reviewer}. New-Interfaces for Musical Expression Conference 2025. 4 papers}
\cvitem{2025}{\textbf{Reviewer}. Neural Computing and Applications, Springer Press, 1 paper.}
