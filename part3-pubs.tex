\section{Academic Publications}
    ...
    \cvitem{J12}{Cotton, K., de Vries K., Holzapfel A., Berglund K., \textcolor{magenta}{Tatar, K.}. \textit{Revising MIR Research Practices for Singing Data Collection}. Submitted to AI and Society, Springer Nature.}
    ...
    \cvitem{J10}{Madaghiele V., Lund L., Holzer D., Kelkar T., \textcolor{magenta}{Tatar, K.}, and Holzapfel A. \textit{Expanding the machine: notating generative synthesis with a state-based representation and an interactive timbre space}. In press at Organised Sound, Cambridge Press.}
